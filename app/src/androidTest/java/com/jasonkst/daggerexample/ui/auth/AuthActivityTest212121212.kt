...
class AuthActivityTest212121212 {
    ...
    fun authActivityTest() {
        ...
        textInputEditText2.perform(replaceText("3"), closeSoftKeyboard())

        val textInputEditText3 = onView(
            allOf(
                withId(R.id.user_id_input), withText("3"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        textView.check(matches(withText("Posts")))
    }
